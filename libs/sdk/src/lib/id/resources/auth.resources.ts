...
export const RequestPasswordResetResource = new ScxEndpoint<RequestPasswordResetOtpDto, { cookies?: CookieStructure[] }>({
	path: '/passwords',
	fullPath: `${AuthBasePath}/passwords`,
	method: HttpMethods.Put
});

export const ResetPasswordResource = new ScxEndpoint<ResetPasswordDto, { cookies?: CookieStructure[] }>({
	path: '/passwords',
	fullPath: `${AuthBasePath}/passwords`,
	method: HttpMethods.Post
});
